                ...
                <div className={"has-text-left"} style={{width: "100%"}}>
                    ...
                    <div className={"column is-12"}>
                        <div className={"toggle-col"}>
                            ...
                            <Textarea className={"dark-textarea"} value={"Hey {user.mention}, welcome to {server.name}!"}
                                      rows={8} min-rows={8}/>
                        </div>
                    </div>
                    <div className={"column is-12"}>
                    ...
                    <div className={"column is-12"}>
                        <div className={"toggle-col"}>
                            ...
                            <div className={"small-spacer-v"}/>
                            <Textarea className={"dark-textarea"} value={"Sorry to see you go, {user.name}..."} rows={8}
                                      min-rows={8}/>
                        </div>
                    </div>
                </div>
